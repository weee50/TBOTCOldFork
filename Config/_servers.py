...
MAIN_SERVER["GENERAL_1"] = discord.utils.get(MAIN_SERVER["MAIN"].channels, id=481509602035236865)
MAIN_SERVER["GENERAL_2"] = discord.utils.get(MAIN_SERVER["MAIN"].channels, id=1129182223262814349)
